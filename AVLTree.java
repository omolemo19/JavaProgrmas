/**
 * Application for the AVLExperiment 
...
{
   private int inOperations;
   private int fdOperations;
   ...
   /**
   *
   * @return Returns the number of comparison operations of the insert method
   */
   public int getInOp(){
   	return inOperations;
   }
   /**
   *
   * @return Returns the number of comparison operations of the find method
   */
   ...
   /**
   *
   * @param Resets the value of inOperations to zero
   */

   public void resetInOp(){
   	inOperations = 0;
   }
   /**
   *
   * @param Resets the value of fdOperations to zero
   */
   public void resetFdOp(){
   	fdOperations = 0;
   }
}
